...
- 整體資訊
  ![「專業人士的設計流程」近 7 天的訪客總覽](/posts/analytics-tool-splitbee/01.jpeg)
- 個別使用者資訊：哪裡來的、裝置訊息、近 6 個月該使用者在網站上的足跡
  ![某位台灣使用者被 Splitbee 記錄的足跡](/posts/analytics-tool-splitbee/02.jpeg)
...
![在 Splitbee 呈現事件的副標題](/posts/analytics-tool-splitbee/03.jpeg)

雖然 Splitbee 內建就會抓外連網址，如果這外連網址是很重要的轉換行為，還是要設定事件，才可以讓 `Funnel` 幫忙統計轉換率。
![在 Splitbee 呈現外連網址的轉換率](/posts/analytics-tool-splitbee/04.jpeg)
...
![在 Discord 新增 Webhook](/posts/analytics-tool-splitbee/05.jpeg)

按下 "Copy Webhook URL"

### 設定 Automation

![Splitbee 填入 Discord 的 Webhook](/posts/analytics-tool-splitbee/06.jpeg)
...
![Bot 在 Discord 顯示 "New Visitor from Taiwan"](/posts/analytics-tool-splitbee/07.jpeg)

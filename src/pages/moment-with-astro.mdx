...
dateModified: "2023-07-23T17:10:00+08:00"
...
- [Astro v.s. Remix](#astro-vs-remix)
- [區分 `<body>` 樣式](#區分-body-樣式)
- [設定 Markdown 語法的樣式](#設定-markdown-語法的樣式)
- [加入結構化資料 JSON LD 語法](#加入結構化資料-json-ld-語法)
- [遇到的 Bug](#遇到的-bug)
...
如果是使用 MDX，這個問題已經在 `@astrojs/mdx@0.11.2` 修正。
...
這個問題已經在[討論區提問](https://discord.com/channels/830184174198718474/1132566884097740841)，正等待回應。

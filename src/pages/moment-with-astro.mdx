...
Moment 根據 Astro 的 [Blog Starter 範例](https://github.com/withastro/astro/tree/main/examples/blog)進行修改，範本裡，基礎是 `preact`，使用的體感跟 React 幾乎沒有差別，後來改用 `Solid.js`，用到後來 Astro 本身幾乎是隱形，跟搭配的框架整合得不錯。

...
上傳到正式環境才發現：Markdown 區塊裡應該要直接顯示環境變數的地方，卻當成一般環境變數顯示，在使用 [SSR](https://docs.astro.build/en/guides/server-side-rendering/#enabling-ssr-in-your-project) 的情況下，甚至會無法 Build 成功。

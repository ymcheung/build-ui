...
type: "article"
---
在蓋「[Moment：看電影看劇時，聽到喜歡的音樂](https://moment.intersection.tw)」專案的時候，覺得輕量級的網站，用 Markdown 語法可以滿足快速、便於更新內容的需求，找到了 [Remix](https://remix.run) 和 Astro。
...
上傳到正式環境才發現：Markdown 區塊裡應該要直接顯示環境變數原始碼的地方，卻直接顯示，或是令人不解的訊息，在使用 [SSR](https://docs.astro.build/en/guides/server-side-rendering/#enabling-ssr-in-your-project) 的情況下，甚至會無法 Build 成功。

Astro 目前已經把[回報的 Issue](https://github.com/withastro/astro/issues/4801) 標示為重要。

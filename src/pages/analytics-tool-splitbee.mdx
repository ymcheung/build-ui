...
dateModified: "2022-10-27T14:00:00+08:00"
...
## ![Splitbee 的標誌](/images/analytics-tool-splitbee/sticker.svg)

- 首頁：https://splitbee.io
- 文件：https://splitbee.io/docs

2022 年 10 月，Splitbee 宣布[被 Vercel 收購](https://vercel.com/blog/vercel-acquires-splitbee)，雖然還可以繼續使用，但預期會成為 [Vercel Analytics](https://vercel.com/analytics) 的一部分。
...
- 整體資訊
  ![「專業人士的設計流程」近 7 天的訪客總覽](/images/analytics-tool-splitbee/01.webp)
- 個別使用者資訊：哪裡來的、裝置訊息、近 6 個月該使用者在網站上的足跡
  ![某位台灣使用者被 Splitbee 記錄的足跡](/images/analytics-tool-splitbee/02.webp)
...
![在 Splitbee 呈現事件的副標題](/images/analytics-tool-splitbee/03.webp)

雖然 Splitbee 內建就會抓外連網址，如果這外連網址是很重要的轉換行為，還是要設定事件，才可以讓 `Funnel` 幫忙統計轉換率。

![在 Splitbee 呈現外連網址的轉換率](/images/analytics-tool-splitbee/04.webp)
...
![在 Discord 新增 Webhook](/images/analytics-tool-splitbee/05.webp)

按下 `Copy Webhook URL`

### 設定 Automation

![Splitbee 填入 Discord 的 Webhook](/images/analytics-tool-splitbee/06.webp)
...
![Bot 在 Discord 顯示 "New Visitor from Taiwan"](/images/analytics-tool-splitbee/07.webp)

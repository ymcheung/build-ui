...
export const UnauthorizedError = () =>
  json({ error: "Unauthorized" } as CatchData, 401);
...
export const ForbiddenError = () =>
  json({ error: "Unauthorized" } as CatchData, 403);
...
export const NotFoundError = () =>
  json({ error: "Not Found" } as CatchData, 404);
...
export const MethodNotAllowedError = () =>
  json({ error: "Method Not Allowed" } as CatchData, 405);
...
export const ImATeaPotError = () =>
  json({ error: "I'm a teapot" } as CatchData, 418);
